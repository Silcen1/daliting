// pages/booking-loading/booking-loading.js
...
Page({
  ...
  onLoad: function (options) {
    ...
    // 拼团订单
    var that = this;
    call.getData('/index.php?store_id=1&r=api/group/order/list&status=0&_version=2.8.9&_platform=w', this.success, this.fail, { access_token: wx.getStorageSync('access_token') }) 
  },
  success(res) {
    console.log(res)
    this.setData({
